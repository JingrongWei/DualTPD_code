...
u_lst = cell(maxIt,1);
sigma_lst = cell(maxIt,1);
p_lst = cell(maxIt,1);
uI_lst = cell(maxIt,1);
pI_lst = cell(maxIt,1);
sigmaI_lst = cell(maxIt,1);
...
save('results1.mat', 'h_lst',  'time_lst','ite_lst', 'N', 'maxIt', 'stepsize', 'tol', 'Vcycle_num');
save('results1', 'L2Err', 'pErr', 'energyErr', 'pde', 'sigmaErr', 'uIuhErr', '-append');
save('results1', 'u_lst', 'p_lst', 'sigma_lst', 'uI_lst', 'sigmaI_lst', '-append');
